...
namespace DVCalc
{
    public partial class MainForm : Form
    {
        ...
        private void CalcButton_Click(object? sender, EventArgs e)
        {
            ...
            int DV = Calculator.findHighestDV(
            ...
            uint maxDVNature = Calculator.getNatureFromPID(Calculator.generatePID(
        ...
        private void ShowAllButton_Click(object? sender, EventArgs e)
        {
            ...
            List<DVIVNatureTriplet> natureDict = Calculator.getAllNatures(
                (uint)trainerIdx.Value, (uint)trainerClassIdx.Value, maleCheck.Checked, pokemonIndex,
